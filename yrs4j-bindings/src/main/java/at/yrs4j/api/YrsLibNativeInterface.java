...
public interface YrsLibNativeInterface extends Library {
     ...
     * <i>native declaration : libyrs.h:938</i>
     */
    Pointer ytransaction_state_diff_v1(YrsTransaction txn, Pointer sv, int sv_len, IntByReference len);
     ...
     * <i>native declaration : libyrs.h:956</i>
     */
    Pointer ytransaction_state_diff_v2(YrsTransaction txn, Pointer sv, int sv_len, IntByReference len);
     ...
     * <i>native declaration : libyrs.h:975</i>
     */
    Pointer ytransaction_encode_state_from_snapshot_v1(YrsTransaction txn, Pointer snapshot, int snapshot_len, IntByReference len);
     ...
     * <i>native declaration : libyrs.h:987</i>
     */
    Pointer ytransaction_encode_state_from_snapshot_v2(YrsTransaction txn, Pointer snapshot, int snapshot_len, IntByReference len);
     ...
     */
    byte ytransaction_apply(YrsTransaction txn, Pointer diff, int diff_len);
     ...
     */
    byte ytransaction_apply_v2(YrsTransaction txn, Pointer diff, int diff_len);
     ...
     * <i>native declaration : libyrs.h:1215</i>
     */
    void ymap_insert(YrsBranch map, YrsTransaction txn, Pointer key, YrsInput value);
     ...
     * <i>native declaration : libyrs.h:1223</i>
     */
    byte ymap_remove(YrsBranch map, YrsTransaction txn, Pointer key);
     ...
     * <i>native declaration : libyrs.h:1232</i>
     */
    YrsOutput ymap_get(YrsBranch map, YrsTransaction txn, Pointer key);
     ...
     */
    YrsInput.ByValue yinput_binary(String buf, int len);
     ...
     */
    YrsInput.ByValue yinput_json_map(PointerByReference keys, YrsInput values, int len);
     ...
     */
    YrsInput.ByValue yinput_yarray(YrsInput values, int len);
     ...
     */
    YrsInput.ByValue yinput_ymap(PointerByReference keys, YrsInput values, int len);
     ...
     */
    YrsInput.ByValue yinput_ytext(ByteBuffer str);
     ...
     */
    YrsInput.ByValue yinput_yxmlelem(ByteBuffer name);
     ...
     */
    YrsInput.ByValue yinput_yxmltext(ByteBuffer str);
     ...
     */
    String youtput_read_binary(YrsOutput val);
