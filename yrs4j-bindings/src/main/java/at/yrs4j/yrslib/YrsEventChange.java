...
/**
 * <i>native declaration : libyrs.h:597</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public class YrsEventChange extends Structure {
	/**
...
<br>
	 ...
	 * C type : YrsOutput*
	 */
	public YrsOutput.ByReference values;
	public YrsEventChange() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("tag", "len", "values");
	}
	/**
...
<br>
	 ...
	 * @param values Used in case when current change is of `Y_EVENT_CHANGE_ADD` type. Contains a list (of
<br>
	 * length stored in `len` field) of newly inserted values.<br>
	 * C type : YrsOutput*
	 */
	public YrsEventChange(byte tag, int len, YrsOutput.ByReference values) {
		super();
		this.tag = tag;
		this.len = len;
		this.values = values;
	}
	public static class ByReference extends YrsEventChange implements Structure.ByReference {
		
	}

    public static class ByValue extends YrsEventChange implements Structure.ByValue {
